...
public class StockDataFetcher {
    ...
    public void fetchHistoricalData(String symbol, String fromDate, String toDate,WebDriver driver) {
        ...
        try {
            ...
            // Wait for the data table to appear if no "no data" message was found
    ...
    public void fetchHistoricalDataTenYears(String symbol,WebDriver driver) {
        try {
            ...
            for (int i = 11; i >0; i--) {
                ...
                // Optionally, you could reset the page state between each fetch
                driver.get(url); // Reload the base URL for each year to reset the page
            }
        ...
        for (String symbol : dropdownValues) {
            ...
            executor.submit(() -> {
                ...
                try {
                    ...
                    System.out.println("Fetched data for symbol: " + symbol);
